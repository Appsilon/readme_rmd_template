---
title: {CHANGE: Repo title}
output: html_document
params:
   website_url: http://appsilondatascience.com
   logo_url: https://cdn.rawgit.com/Appsilon/website-cdn/gh-pages/logo-white.png

   repo_name: {CHANGE: repo.name}
   repo_url: {CHANGE: http://appsilondatascience.com/repo}
   demo_url: {CHANGE: http://appsilondatascience.com/demo}
   chagelog_url: {CHANGE: http://appsilondatascience.com/repo_changelog}
---
...
<div class="subheader">{CHANGE: SemanticUI wrapper for Shiny}</div>

<div class="section level2">
{CHANGE:  Your repo short description here}
